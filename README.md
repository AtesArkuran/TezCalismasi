...
## 1. Human Activity Recognition for Mobile Robot 

https://www.researchgate.net/publication/322675054_Human_Activity_Recognition_for_Mobile_Robot

[Human Activity Recognition for Mobile Robot PDF](PDFs/1_Human_Activity_Recognition_for_Mobile_Robot.pdf)
...
## 2. Human Activity Recognition with Deep Reinforcement Learning using the Camera of a Mobile Robot
...
## 3. Robotic Search and Rescue using Human Detection System
...
## 4. Duruş ve Hareket Algılama Teknolojileri: Stereo, Uçuş Süresi ve Yapısal Işık Algılayıcılar
...
## 5. Human Activity Recognition for Domestic Robots
...
## 6. Human Activity Recognition Using a Mobile Camera
...
## 7. Mobile Camera Positioning to Optimize The Observability of Human Activity Recognition Tasks
...
## 8. A Depth Camera-based Human Activity Recognition via Deep Learning Recurrent Neural Network for Health and Social Care Services
...
## 9. A Multimodal Approach for Human Activity Recognition Based on Skeleton and RGB Data
...
## 10. Real-Time Human Action Recognition with a Low-Cost RGB Camera and Mobile Robot Platform
